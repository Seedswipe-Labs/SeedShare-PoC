...
// Interfaces
import '.././interface/ISeedBaseClaimRegistry.sol';

/**
    
    SeedCoreCompliance works in tandem with SeedShare and the SeedBaseClaimRegistry,
    ...
    Share transfer is initiated the SeedCoreCompliance contract iterates through the
    necessary claims, comparing them against the claims held by the prospective
    Shareholder in the SeedBaseClaimRegistry. 

 */
contract SeedCoreCompliance is ISeedCoreCompliance, Ownable {
     ...
     */
    ISeedBaseClaimRegistry private _claimRegistry;
    ...
    function setClaimRegistry(
        ...
        onlyOwner
    {
        _claimRegistry = ISeedBaseClaimRegistry(claimRegistry);
