...
/**
    ...
    SeedCoreDelegates keeps a record of delegation for voting.

 */

contract SeedCoreDelegates is SeedCore, ISeedCoreDelegates  {
    ...
    {
        (, address from, address to, uint256 id, uint256 amount, bytes memory data) = abi.decode(SeedCoreData, (address, address, address, uint256, uint256, bytes));
