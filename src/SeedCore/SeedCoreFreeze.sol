...
// Inherited
import './SeedCore.sol';
import '../interface/ISeedCoreFreeze.sol';

/**

    SeedCoreFreeze enforces transfer restrictions around frozen Share contracts, 
    Share classes, users, etc.

 */

contract SeedCoreFreeze is SeedCore, ISeedCoreFreeze  {
